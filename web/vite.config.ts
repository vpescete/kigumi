...
// In dev the React app and the Rust API are separate processes; proxy the API paths to the running
// `meshble serve` (default bind 127.0.0.1:8099) so the browser stays same-origin (no CORS needed).
