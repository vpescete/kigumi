...
kigumi_core::inventory::submit! { ModelRegistration { name: "att.host", module: "test", descriptor: host_d } }
kigumi_core::inventory::submit! { ModelRegistration { name: "ir.attachment", module: "test", descriptor: att_d } }
