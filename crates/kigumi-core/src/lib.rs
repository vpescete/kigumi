//! Kigumi core: the inspectable metamodel + the module versioning model.
//!
...
pub use security::{
    ...
    FieldGroupRegistration, Operation, RecordRule, RuleDomain, PUBLIC_GROUP,
};

// Re-export for the paths generated by the macros (`::kigumi::inventory::submit!`).
pub use inventory;
