...
use meshble_db::{BoxServiceFut, Db, DbError, ServiceCtx, ServiceInput, ServiceOutput, ServiceRegistration};
...
meshble_core::inventory::submit! { ModelRegistration { name: "svc.doc", module: "test", descriptor: f_doc } }
