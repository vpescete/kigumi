...
meshble_core::inventory::submit! { ModelRegistration { name: "test.thing", module: "test", descriptor: f_thing } }
meshble_core::inventory::submit! { ModelRegistration { name: "test.wiz", module: "test", descriptor: f_wiz } }
meshble_core::inventory::submit! { TransientRegistration { model: "test.wiz" } }
...
meshble_core::inventory::submit! { WizardRegistration { model: "test.wiz", default_get: seed_wiz } }
