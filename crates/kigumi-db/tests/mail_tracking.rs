...
kigumi_core::inventory::submit! { ModelRegistration { name: "tr.doc", module: "test", descriptor: doc_desc } }
kigumi_core::inventory::submit! { MailedRegistration { model: "tr.doc" } }
// `state` and `due_at` are tracked; `name` is not.
kigumi_core::inventory::submit! { TrackedFieldRegistration { model: "tr.doc", field: "state" } }
kigumi_core::inventory::submit! { TrackedFieldRegistration { model: "tr.doc", field: "due_at" } }
