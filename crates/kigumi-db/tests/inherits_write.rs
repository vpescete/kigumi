...
kigumi_core::inventory::submit! { ModelRegistration { name: "wr.tpl", module: "test", descriptor: tpl } }
kigumi_core::inventory::submit! { ModelRegistration { name: "wr.var", module: "test", descriptor: var } }
kigumi_core::inventory::submit! { InheritsRegistration { model: "wr.var", parent: "wr.tpl", via: "tpl_id" } }
