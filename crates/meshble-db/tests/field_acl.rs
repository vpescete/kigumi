...
meshble_core::inventory::submit! { ModelRegistration { name: "fa.doc", module: "test", descriptor: doc_desc } }
// `secret` requires the "mgr" group (what `#[field(groups = "mgr")]` would emit).
meshble_core::inventory::submit! { FieldGroupRegistration { model: "fa.doc", field: "secret", groups: &["mgr"] } }
...
meshble_core::inventory::submit! { ModelRegistration { name: "fa.par", module: "test", descriptor: par_desc } }
meshble_core::inventory::submit! { ModelRegistration { name: "fa.lin", module: "test", descriptor: lin_desc } }
meshble_core::inventory::submit! { ModelRegistration { name: "fa.ref", module: "test", descriptor: ref_desc } }
// The One2many `lines` field is itself manager-only (D6 restriction on a relation field).
meshble_core::inventory::submit! { FieldGroupRegistration { model: "fa.par", field: "lines", groups: &["mgr"] } }
