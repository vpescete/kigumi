...
meshble_core::inventory::submit! { ModelRegistration { name: "rl.parent", module: "test", descriptor: p_desc } }
meshble_core::inventory::submit! { ModelRegistration { name: "rl.child", module: "test", descriptor: c_desc } }
meshble_core::inventory::submit! { RelatedRegistration { model: "rl.child", field: "parent_code", path: "parent_id.code" } }
meshble_core::inventory::submit! { RelatedRegistration { model: "rl.child", field: "parent_due", path: "parent_id.due" } }
