...
meshble_core::inventory::submit! { ModelRegistration { name: "cas.group", module: "test", descriptor: g_desc } }
meshble_core::inventory::submit! { ModelRegistration { name: "cas.order", module: "test", descriptor: o_desc } }
meshble_core::inventory::submit! { ModelRegistration { name: "cas.line", module: "test", descriptor: l_desc } }
...
meshble_core::inventory::submit! { meshble_core::ComputeRegistration { name: "cas_order_amount", func: order_amount } }
meshble_core::inventory::submit! { meshble_core::ComputeRegistration { name: "cas_group_total", func: group_total } }
