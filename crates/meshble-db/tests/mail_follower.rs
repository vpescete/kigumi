...
meshble_core::inventory::submit! { ModelRegistration { name: "fol.doc", module: "test", descriptor: doc_desc } }
meshble_core::inventory::submit! { MailedRegistration { model: "fol.doc" } }
