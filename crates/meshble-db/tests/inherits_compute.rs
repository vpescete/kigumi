...
use meshble_core::{resolve_registered, Acl, ComputeInput, Ctx, FieldDef, FieldKind, InheritsRegistration, ModelDescriptor, ModelRegistration, Value};
use meshble_db::Db;
use serde_json::json;
...
meshble_core::inventory::submit! { meshble_core::ComputeRegistration { name: "ic_display", func: ic_display } }
...
meshble_core::inventory::submit! { ModelRegistration { name: "ic.tpl", module: "test", descriptor: tpl } }
meshble_core::inventory::submit! { ModelRegistration { name: "ic.var", module: "test", descriptor: var } }
meshble_core::inventory::submit! { InheritsRegistration { model: "ic.var", parent: "ic.tpl", via: "tpl_id" } }
