...
meshble_core::inventory::submit! { ModelRegistration { name: "mm.post", module: "test", descriptor: post_desc } }
meshble_core::inventory::submit! { ModelRegistration { name: "mm.tag", module: "test", descriptor: tag_desc } }
