...
meshble_core::inventory::submit! { ModelRegistration { name: "mc.company", module: "test", descriptor: company_desc } }
meshble_core::inventory::submit! { ModelRegistration { name: "mc.doc", module: "test", descriptor: doc_desc } }
