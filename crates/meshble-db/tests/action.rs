...
meshble_core::inventory::submit! { ModelRegistration { name: "act.order", module: "test", descriptor: order_desc } }
...
meshble_core::inventory::submit! { meshble_core::ActionRegistration { model: "act.order", name: "confirm", func: confirm, groups: &[] } }
