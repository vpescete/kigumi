...
meshble_core::inventory::submit! { ModelRegistration { name: "sp.tpl", module: "test", descriptor: tpl } }
meshble_core::inventory::submit! { ModelRegistration { name: "sp.var", module: "test", descriptor: var } }
meshble_core::inventory::submit! { InheritsRegistration { model: "sp.var", parent: "sp.tpl", via: "tpl_id" } }
meshble_core::inventory::submit! { FieldGroupRegistration { model: "sp.tpl", field: "cost", groups: &["mgr"] } }
meshble_core::inventory::submit! { FieldGroupRegistration { model: "sp.tpl", field: "secret", groups: &["mgr"] } }
