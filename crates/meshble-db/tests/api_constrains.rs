...
use meshble_core::{resolve, Acl, ComputeInput, Ctx, FieldDef, FieldKind, ModelDescriptor, ModelRegistration, ResolvedModel};
use meshble_db::Db;
use serde_json::json;
...
meshble_core::inventory::submit! {
    meshble_core::ConstraintRegistration { model: "con.order", fields: &["header_total", "line_ids"], func: balanced }
}
...
meshble_core::inventory::submit! { ModelRegistration { name: "con.order", module: "test", descriptor: order_d } }
meshble_core::inventory::submit! { ModelRegistration { name: "con.line", module: "test", descriptor: line_d } }
