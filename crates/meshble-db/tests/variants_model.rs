...
meshble_core::inventory::submit! { ModelRegistration { name: "va.tag", module: "test", descriptor: tag_desc } }
meshble_core::inventory::submit! { ModelRegistration { name: "va.cat", module: "test", descriptor: cat_desc } }
meshble_core::inventory::submit! { ModelRegistration { name: "va.item", module: "test", descriptor: item_desc } }
