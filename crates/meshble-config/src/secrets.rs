//! Secrets — read from the environment ONLY (never from `meshble.toml`), presence verified at
...
impl Secrets {
    pub fn from_env() -> Result<Secrets, ConfigError> {
        ...
        Ok(Secrets {
            ...
            smtp_password: opt("MESHBLE_SMTP_PASSWORD"),
            admin_token: opt("MESHBLE_ADMIN_TOKEN"),
        })
    }
}
